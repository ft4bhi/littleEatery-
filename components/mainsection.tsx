  ...
  return (
    <div className=" md:w-full bg-white relative flex flex-col md:flex-row md:justify-around items-center justify-end h-[600px] md:h-full">
      <div className=" w-full md:w-[50%]  flex flex-col px-10 md:px-20 z-30">
        ...
        <div className="tracking-[0.01em] leading-[130%] sm:text-[16px]  text-[14px] md:text-[22px] w-full md:w-[600px] text-wrap pt-6 md:text-[#797979] text-gray-200">
          Our job is delivering a delicious food with fast , free delivery and
          easy.
        </div>
        <div className=" flex felx-col md:flex-row gap-4 md:gap-12 mt-4">
          <button className="w-[120px] p-2 rounded-3xl  text-white bg-[#f39945] hover:opacity-90">
            Menu
          </button>
          <div className="p-2 px-4 rounded-3xl md:text-[#EC994B] text-white border-[#f39945] border    ">
        ...
        <div className="flex flex-row justify-center md:justify-start py-8 px-14 gap-10">
          <Link href="/">
            <svg
      ...
      <div  className="absolute top-0 md:relative  md:w-[400px] md:rounded-tl-3xl md:rounded-br-3xl md:rounded-md z-20 overflow-hidden">
        <Carousel>
          {slides.map((s) => (
