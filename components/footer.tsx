...
const Footer = memo(() => {
  return (
    <footer className="w-full bg-white flex flex-row  justify-around py-6  box-border text-base text-gray-600 font-h3 border-t border-gray-200">
      ...
      <div className="flex flex-col w-[200px] gap-6 text-center py-9">
        <h1>
      ...
      <div className="flex flex-col w-[200px] gap-6 text-left  py-9">
        <h1>
      ...
      <div className="flex flex-col w-[200px] gap-6 text-center py-9">
        ...
        <div className="relative">
            <input className=" p-3 rounded-full r shadow-xl" placeholder="Enter your email..." type="email">
            </input>
