...
const FoodSlider = () => {
  ...
  const foodItems = [
    {
      ...
      price: "$10",
      rating: "4.5",
      img: "/assets/food/1.jpeg", // Relative path for images in public/assets
    },
    {
      id: 2,
      name: "Pancake",
  ...
  return (
    <div className="pt-20 mb-10 px-4 overflow-hidden relative">
      <p className="text-center text-[#EC994B]">-Popular Delivery-</p>
      <h2 className="text-center text-2xl font-bold mb-6">Trending Food</h2>
        ...
        <div className="relative h-full flex items-center justify-center">
          {getVisibleItems().map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="absolute transition-all ease-in-out duration-500 w-[500px]"
                style={{
